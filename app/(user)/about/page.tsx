    ...
    return (
        <div className="bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-lg text-gray-700 mb-6">
                    Whether you&apos;re a seasoned shopper or new to online retail, we welcome you to explore our website and discover the convenience of shopping with STAD Commerce. Thank you for choosing us as your trusted online retailer.
                </p>
            </div>
        </div>
    );
