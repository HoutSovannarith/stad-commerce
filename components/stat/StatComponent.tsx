        ...
        <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-gray-500 sm:text-xl">
                    ...
                    Discover top-quality electronic components at Stat Components. From resistors to microcontrollers, find everything you need for your projects. Shop now for reliability and excellence in every component.
                </p>
            </div>
